...
// source: github.com/TriggerMail/luci-go/buildbucket/proto/common.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/buildbucket/proto/common.proto", fileDescriptor_a1a0c34bd7fcf0dc)
}
