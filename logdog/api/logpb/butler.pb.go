...
// source: github.com/TriggerMail/luci-go/logdog/api/logpb/butler.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/logdog/api/logpb/butler.proto", fileDescriptor_25f3936477fa1e93)
}
