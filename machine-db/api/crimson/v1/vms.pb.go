...
// source: github.com/TriggerMail/luci-go/machine-db/api/crimson/v1/vms.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/machine-db/api/crimson/v1/vms.proto", fileDescriptor_ac68362bdfdec1d3)
}
