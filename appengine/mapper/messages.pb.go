...
// source: github.com/TriggerMail/luci-go/appengine/mapper/messages.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/appengine/mapper/messages.proto", fileDescriptor_009da4539d0ef669)
}
