...
// source: github.com/TriggerMail/luci-go/machine-db/api/crimson/v1/vm_slots.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/machine-db/api/crimson/v1/vm_slots.proto", fileDescriptor_620049fabde60637)
}
