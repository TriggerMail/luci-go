...
// source: github.com/TriggerMail/luci-go/machine-db/api/crimson/v1/racks.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/machine-db/api/crimson/v1/racks.proto", fileDescriptor_5e7bc6de9b3dbb6d)
}
