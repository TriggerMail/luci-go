...
// source: github.com/TriggerMail/luci-go/dm/api/acls/acls.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/dm/api/acls/acls.proto", fileDescriptor_0a85e1525a5d8e6b)
}
