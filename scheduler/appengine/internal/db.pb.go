...
// source: github.com/TriggerMail/luci-go/scheduler/appengine/internal/db.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/scheduler/appengine/internal/db.proto", fileDescriptor_1cbb24b54b0d9994)
}
