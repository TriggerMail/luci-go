...
// source: github.com/TriggerMail/luci-go/machine-db/api/crimson/v1/kvms.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/machine-db/api/crimson/v1/kvms.proto", fileDescriptor_1ff02130521e1400)
}
