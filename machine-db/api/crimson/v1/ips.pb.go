...
// source: github.com/TriggerMail/luci-go/machine-db/api/crimson/v1/ips.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/machine-db/api/crimson/v1/ips.proto", fileDescriptor_e1b68683c7632367)
}
