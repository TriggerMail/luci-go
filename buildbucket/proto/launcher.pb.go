...
// source: github.com/TriggerMail/luci-go/buildbucket/proto/launcher.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/buildbucket/proto/launcher.proto", fileDescriptor_45f9e6fb262a81d2)
}
