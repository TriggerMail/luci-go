...
// source: github.com/TriggerMail/luci-go/machine-db/api/crimson/v1/hosts.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/machine-db/api/crimson/v1/hosts.proto", fileDescriptor_e5f10a1e6da138ab)
}
