...
// source: github.com/TriggerMail/luci-go/luci_notify/api/config/settings.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/luci_notify/api/config/settings.proto", fileDescriptor_425f8f86e1321f04)
}
