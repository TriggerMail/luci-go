...
// source: github.com/TriggerMail/luci-go/common/tsmon/ts_mon_proto/metrics.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/common/tsmon/ts_mon_proto/metrics.proto", fileDescriptor_5a1f5514585a4442)
}
