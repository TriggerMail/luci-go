...
// source: github.com/TriggerMail/luci-go/tokenserver/api/machine_token.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/tokenserver/api/machine_token.proto", fileDescriptor_dff8dcc9d4458b55)
}
