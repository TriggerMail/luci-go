...
// source: github.com/TriggerMail/luci-go/machine-db/api/crimson/v1/nics.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/machine-db/api/crimson/v1/nics.proto", fileDescriptor_04c10592cdcb6ab3)
}
