...
// source: github.com/TriggerMail/luci-go/machine-db/api/crimson/v1/vlans.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/machine-db/api/crimson/v1/vlans.proto", fileDescriptor_674503a3aa3cd9ab)
}
