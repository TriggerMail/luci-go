...
// source: github.com/TriggerMail/luci-go/buildbucket/proto/step.proto
...
type Step_Log struct {
	...
	// See also
	// https://godoc.org/github.com/TriggerMail/luci-go/logdog/common/types#ParseURL
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/buildbucket/proto/step.proto", fileDescriptor_7b6755933d248870)
}
