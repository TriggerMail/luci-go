...
// source: github.com/TriggerMail/luci-go/machine-db/api/config/v1/oses.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/machine-db/api/config/v1/oses.proto", fileDescriptor_f0809eab694e34b5)
}
