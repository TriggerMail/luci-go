...
// source: github.com/TriggerMail/luci-go/buildbucket/proto/notification.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/buildbucket/proto/notification.proto", fileDescriptor_afccefc352997ed1)
}
