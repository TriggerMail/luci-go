...
// source: github.com/TriggerMail/luci-go/common/tsmon/ts_mon_proto/any.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/common/tsmon/ts_mon_proto/any.proto", fileDescriptor_58f91f4e40f17744)
}
