...
// source: github.com/TriggerMail/luci-go/tokenserver/api/oauth_token_grant.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/tokenserver/api/oauth_token_grant.proto", fileDescriptor_2e508b3aaac47612)
}
