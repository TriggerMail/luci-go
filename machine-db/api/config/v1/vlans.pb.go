...
// source: github.com/TriggerMail/luci-go/machine-db/api/config/v1/vlans.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/machine-db/api/config/v1/vlans.proto", fileDescriptor_bb654d86333e52aa)
}
