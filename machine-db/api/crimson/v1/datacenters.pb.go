...
// source: github.com/TriggerMail/luci-go/machine-db/api/crimson/v1/datacenters.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/machine-db/api/crimson/v1/datacenters.proto", fileDescriptor_7a7700e9dfb0b4ca)
}
