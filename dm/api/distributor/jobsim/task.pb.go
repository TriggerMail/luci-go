...
// source: github.com/TriggerMail/luci-go/dm/api/distributor/jobsim/task.proto
...
func init() {
	proto.RegisterFile("github.com/TriggerMail/luci-go/dm/api/distributor/jobsim/task.proto", fileDescriptor_5cdcbaf2009df1de)
}
